...
stds.roblox = {
    ...
    read_globals = {
        ...
        table = def_fields({"clone", "clear", "concat", "foreach", "foreachi", "getn", "insert", "remove", "sort",
        ...
        task = def_fields({"spawn", "defer", "delay", "wait", "cancel"}),
        ...
        CFrame = def_fields({"new", "lookAt", "fromEulerAnglesXYZ", "Angles", "fromOrientation",
